...
public value class UInt @kotlin.internal.IntrinsicConstEvaluation @PublishedApi internal constructor(@PublishedApi internal val data: Int) : Comparable<UInt> {
    ...
    public override inline operator fun compareTo(other: UInt): Int = error("Stub")
    ...
    /** Divides this value by the other value, truncating the result to an integer that is closer to zero. */
    @kotlin.internal.InlineOnly
    public inline operator fun div(other: UInt): UInt = error("Stub")
    /** Divides this value by the other value, truncating the result to an integer that is closer to zero. */
    @kotlin.internal.InlineOnly
     ...
     */
    @kotlin.internal.InlineOnly
    public inline operator fun rem(other: UInt): UInt = error("Stub")
    /**
     * Calculates the remainder of truncating division of this value (dividend) by the other value (divisor).
     *
     * The result is always less than the divisor.
     ...
     */
    @kotlin.internal.InlineOnly
    public inline fun toLong(): Long = error("Stub")
     ...
     */
    @kotlin.internal.InlineOnly
    public inline fun toULong(): ULong = error("Stub")
...
@SinceKotlin("1.5")
@kotlin.internal.InlineOnly
public inline fun Float.toUInt(): UInt = error("Stub")
/**
...
@SinceKotlin("1.5")
@kotlin.internal.InlineOnly
public inline fun Double.toUInt(): UInt = error("Stub")

...
public class Char : Comparable<Char> {
    public val value: Int get() = error("Stub")
    //@SinceKotlin("1.5")
    ...
    public operator fun rangeTo(other: Char): CharRange = error("Stub")
     ...
     */
    @SinceKotlin("1.9")
    public operator fun rangeUntil(other: Char): CharRange = error("Stub")

...
internal constructor(
    ...
    init {
        if (step == 0.toInt()) throw Throwable("Step must be non-zero.")
        if (step == Int.MIN_VALUE) throw Throwable("Step must be greater than Int.MIN_VALUE to avoid overflow on negation.")
    }

...
internal constructor(
    ...
    init {
        if (step == 0.toLong()) throw Throwable("Step must be non-zero.")
        if (step == Long.MIN_VALUE) throw Throwable("Step must be greater than Long.MIN_VALUE to avoid overflow on negation.")
    }

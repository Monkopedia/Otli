 ...
 */
public inline fun <T> arrayOfNulls(size: Int): Array<T?> = error("Stub")

/**
 * Returns an array containing the specified elements.
 */
public inline fun <T> arrayOf(vararg elements: T): Array<T> = error("Stub")
 ...
 */
@SinceKotlin("1.1")
public inline fun <reified T : Enum<T>> enumValues(): Array<T> = error("Stub")

/**
 * Returns an enum entry with specified name.
 */
@SinceKotlin("1.1")
public inline fun <reified T : Enum<T>> enumValueOf(name: String): T = error("Stub")

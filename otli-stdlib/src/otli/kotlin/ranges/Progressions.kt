...
public open class CharProgression
    ...
    init {
        if (step == 0) throw kotlin.Throwable("Step must be non-zero.")
        if (step == Int.MIN_VALUE) throw kotlin.Throwable("Step must be greater than Int.MIN_VALUE to avoid overflow on negation.")
    }
...
public open class LongProgression
    ...
    init {
        if (step == 0L) throw kotlin.Throwable("Step must be non-zero.")
        if (step == Long.MIN_VALUE) throw kotlin.Throwable("Step must be greater than Long.MIN_VALUE to avoid overflow on negation.")
    }
